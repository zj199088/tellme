...
-- 瑜伽动作
('下犬式', 'Downward Dog', 16, 'beginner', '全身', '瑜伽垫', '经典瑜伽体式，拉伸背部和腿部', 200.00, 1, 1),
...
('卷腹', 'Roll Up', 17, 'beginner', '腹直肌', '瑜伽垫', '控制卷腹，提高脊柱灵活性', 250.00, 1, 1),
('单腿画圈', 'Single Leg Circles', 17, 'intermediate', '髋部、核心', '瑜伽垫', '增强髋部灵活性和核心稳定性', 280.00, 1, 1),
('桥式', 'Bridge', 17, 'beginner', '臀部、核心', '瑜伽垫', '增强臀部和后侧链力量', 260.00, 1, 1),
('游泳式', 'Swimming', 17, 'advanced', '背部、臀部', '瑜伽垫', '增强背部力量和协调性', 320.00, 1, 0),

-- 爆发力训练动作
('跳箱', 'Box Jump', 18, 'intermediate', '腿部、臀部', '跳箱', '提高腿部爆发力', 500.00, 1, 0),
('深蹲跳', 'Jump Squat', 18, 'intermediate', '腿部、臀部', '自重', '经典爆发力训练动作', 480.00, 1, 1),
('俯卧撑跳', 'Plyometric Push-up', 18, 'advanced', '胸部、手臂', '自重或瑜伽垫', '提高上肢爆发力', 450.00, 1, 1),
('壶铃摆动', 'Kettlebell Swing', 18, 'intermediate', '臀部、核心', '壶铃', '全身爆发力训练', 550.00, 1, 0),
('药球砸地', 'Medicine Ball Slam', 18, 'intermediate', '核心、全身', '药球', '释放力量的爆发力训练', 520.00, 1, 0),

-- 平衡训练动作
('单腿站立', 'Single Leg Stand', 19, 'beginner', '平衡、脚踝', '自重', '基础平衡训练', 150.00, 1, 1),
('燕式平衡', 'Bird-Dog', 19, 'beginner', '核心、平衡', '瑜伽垫', '提高核心稳定性和平衡', 180.00, 1, 1),
('单腿深蹲', 'Single Leg Squat', 19, 'advanced', '腿部、平衡', '自重', '高级平衡和力量训练', 350.00, 1, 1),
('平衡板站立', 'Balance Board Stand', 19, 'intermediate', '平衡、核心', '平衡板', '使用器械的平衡训练', 200.00, 1, 0),
('闭眼单腿站', 'Single Leg Stand with Eyes Closed', 19, 'advanced', '平衡、本体感觉', '自重', '挑战平衡感的训练', 160.00, 1, 1),

-- 敏捷训练动作
('梯子训练', 'Agility Ladder', 20, 'beginner', '敏捷、脚步', '敏捷梯', '提高脚步频率和敏捷性', 400.00, 1, 0),
