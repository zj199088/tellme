...
-- 休闲运动 - 散步
('轻松散步', 'Leisure Walk', 10, 'beginner', '全身', '舒适的鞋', '轻松的散步运动，适合日常放松', 150.00, 1, 1),
('快走', 'Brisk Walk', 10, 'beginner', '全身', '舒适的鞋', '稍快的步行速度，增加锻炼效果', 200.00, 1, 1),
-- 休闲运动 - 钓鱼
('钓鱼', 'Fishing', 11, 'beginner', '手臂、核心', '鱼竿、钓具', '钓鱼是一种放松身心的户外休闲活动', 80.00, 1, 0),
('飞钓', 'Fly Fishing', 11, 'intermediate', '手臂、核心', '飞钓装备', '技术型钓鱼，需要更多技巧', 100.00, 0, 0),
-- 休闲运动 - 骑行
('休闲骑行', 'Casual Cycling', 12, 'beginner', '腿部、心肺', '自行车', '轻松的骑行运动，欣赏沿途风景', 250.00, 1, 0),
('城市骑行', 'Urban Cycling', 12, 'beginner', '腿部、心肺', '自行车', '在城市中骑行，通勤锻炼两不误', 280.00, 1, 0),
-- 休闲运动 - 户外活动
('野餐', 'Picnic', 13, 'beginner', '全身', '野餐垫、食物', '户外野餐，享受大自然', 50.00, 0, 0),
('徒步旅行', 'Hiking', 13, 'intermediate', '腿部、心肺', '徒步鞋、背包', '户外徒步，探索自然', 350.00, 1, 1),
('露营', 'Camping', 13, 'beginner', '全身', '露营装备', '野外露营，亲近自然', 100.00, 0, 0),
('登山', 'Mountaineering', 13, 'advanced', '腿部、心肺、核心', '登山装备', '挑战山峰，考验体力', 450.00, 1, 0),

-- 胸部训练动作
('俯卧撑', 'Push-up', 15, 'beginner', '胸大肌、三角肌前束、肱三头肌', '瑜伽垫(可选)', '经典的胸部自重训练动作，锻炼胸肌和手臂力量', 300.00, 1, 1),
('杠铃卧推', 'Barbell Bench Press', 15, 'intermediate', '胸大肌、三角肌前束、肱三头肌', '卧推凳、杠铃、杠铃片', '最经典的胸肌训练动作，可以有效增加胸部厚度', 400.00, 1, 0),
('哑铃飞鸟', 'Dumbbell Fly', 15, 'intermediate', '胸大肌、胸小肌', '卧推凳、哑铃', '孤立训练胸肌的动作，有助于塑造胸部线条', 350.00, 1, 0),

-- 背部训练动作
('引体向上', 'Pull-up', 16, 'advanced', '背阔肌、肱二头肌、斜方肌', '单杠', '最好的背部自重训练动作，需要较强力量', 450.00, 1, 1),
('杠铃划船', 'Barbell Row', 16, 'intermediate', '背阔肌、斜方肌、菱形肌', '杠铃、杠铃片', '增加背部厚度的经典动作', 400.00, 1, 0),
('高位下拉', 'Lat Pulldown', 16, 'beginner', '背阔肌、大圆肌、肱二头肌', '高位下拉器械', '适合初学者的背部训练动作', 380.00, 1, 0),

-- 腿部训练动作
('深蹲', 'Squat', 17, 'beginner', '股四头肌、臀大肌、腘绳肌', '自重或杠铃', '腿部训练的王牌动作，全身性复合动作', 500.00, 1, 1),
('杠铃深蹲', 'Barbell Squat', 17, 'intermediate', '股四头肌、臀大肌、核心肌群', '深蹲架、杠铃、杠铃片', '增加腿部力量和肌肉维度的最佳动作', 600.00, 1, 0),
('腿举', 'Leg Press', 17, 'beginner', '股四头肌、臀大肌', '腿举器械', '对膝盖压力较小的腿部训练动作', 450.00, 1, 0),

-- 肩部训练动作
('肩部推举', 'Shoulder Press', 18, 'beginner', '三角肌前中束、肱三头肌', '哑铃或杠铃', '肩部训练的基础动作', 350.00, 1, 0),
('侧平举', 'Lateral Raise', 18, 'beginner', '三角肌中束', '哑铃', '塑造肩部宽度的绝佳动作', 300.00, 1, 0),
('俯身飞鸟', 'Bent-over Fly', 18, 'intermediate', '三角肌后束', '哑铃', '锻炼肩部后束，改善体态', 320.00, 1, 0),

-- 手臂训练动作
('二头弯举', 'Bicep Curl', 19, 'beginner', '肱二头肌', '哑铃或杠铃', '最经典的二头肌训练动作', 300.00, 1, 0),
('三头下压', 'Tricep Pushdown', 19, 'beginner', '肱三头肌', '龙门架', '锻炼三头肌的高效动作', 320.00, 1, 0),
('锤式弯举', 'Hammer Curl', 19, 'beginner', '肱二头肌、肱肌', '哑铃', '同时锻炼二头肌和前臂', 310.00, 1, 0),

-- 核心训练动作
('卷腹', 'Crunch', 20, 'beginner', '腹直肌', '瑜伽垫', '经典的腹肌训练动作', 250.00, 1, 1),
('平板支撑', 'Plank', 20, 'beginner', '核心肌群', '瑜伽垫', '训练核心稳定性的最佳动作', 280.00, 1, 1),
('仰卧抬腿', 'Leg Raise', 20, 'intermediate', '下腹部', '瑜伽垫', '针对下腹部的训练动作', 260.00, 1, 1),

-- 有氧运动
('慢跑', 'Jogging', 21, 'beginner', '全身', '舒适的跑鞋', '简单有效的有氧运动', 400.00, 1, 1),
('动感单车', 'Spinning', 22, 'intermediate', '腿部、心肺', '动感单车', '高强度的有氧训练', 500.00, 1, 0),
('游泳', 'Swimming', 23, 'intermediate', '全身', '游泳池', '对关节友好的全身有氧运动', 600.00, 1, 0),
('跳绳', 'Jump Rope', 24, 'beginner', '全身、心肺', '跳绳', '高效的燃脂运动', 700.00, 1, 1),

-- 柔韧性训练 - 拉伸运动
('全身拉伸', 'Full Body Stretch', 25, 'beginner', '全身肌肉', '瑜伽垫', '完整的全身静态拉伸，放松肌肉', 100.00, 1, 1),
('颈部拉伸', 'Neck Stretch', 25, 'beginner', '颈部肌肉', '自重', '缓解颈部疲劳的简单拉伸', 50.00, 1, 1),
('腿部拉伸', 'Leg Stretch', 25, 'beginner', '腿部肌肉', '瑜伽垫', '针对大腿和小腿的深度拉伸', 80.00, 1, 1),
-- 柔韧性训练 - 瑜伽
('下犬式', 'Downward Dog', 26, 'beginner', '全身', '瑜伽垫', '经典瑜伽体式，拉伸背部和腿部', 200.00, 1, 1),
('猫牛式', 'Cat-Cow', 26, 'beginner', '脊柱', '瑜伽垫', '脊柱灵活性训练，缓解背部不适', 180.00, 1, 1),
('战士一式', 'Warrior I', 26, 'beginner', '腿部、核心', '瑜伽垫', '增强腿部力量和平衡感', 220.00, 1, 1),
('树式', 'Tree Pose', 26, 'intermediate', '平衡、核心', '瑜伽垫', '提高平衡能力和专注力', 200.00, 1, 1),
('婴儿式', 'Child''s Pose', 26, 'beginner', '背部、臀部', '瑜伽垫', '放松恢复体式', 150.00, 1, 1),

-- 柔韧性训练 - 普拉提
('百次拍击', 'The Hundred', 27, 'intermediate', '核心、呼吸', '瑜伽垫', '经典普拉提动作，增强核心力量', 300.00, 1, 1),
('卷腹', 'Roll Up', 27, 'beginner', '腹直肌', '瑜伽垫', '控制卷腹，提高脊柱灵活性', 250.00, 1, 1),
('单腿画圈', 'Single Leg Circles', 27, 'intermediate', '髋部、核心', '瑜伽垫', '增强髋部灵活性和核心稳定性', 280.00, 1, 1),
('桥式', 'Bridge', 27, 'beginner', '臀部、核心', '瑜伽垫', '增强臀部和后侧链力量', 260.00, 1, 1),
('游泳式', 'Swimming', 27, 'advanced', '背部、臀部', '瑜伽垫', '增强背部力量和协调性', 320.00, 1, 0),

-- 功能性训练 - 爆发力训练
('跳箱', 'Box Jump', 28, 'intermediate', '腿部、臀部', '跳箱', '提高腿部爆发力', 500.00, 1, 0),
('深蹲跳', 'Jump Squat', 28, 'intermediate', '腿部、臀部', '自重', '经典爆发力训练动作', 480.00, 1, 1),
('俯卧撑跳', 'Plyometric Push-up', 28, 'advanced', '胸部、手臂', '自重或瑜伽垫', '提高上肢爆发力', 450.00, 1, 1),
('壶铃摆动', 'Kettlebell Swing', 28, 'intermediate', '臀部、核心', '壶铃', '全身爆发力训练', 550.00, 1, 0),
('药球砸地', 'Medicine Ball Slam', 28, 'intermediate', '核心、全身', '药球', '释放力量的爆发力训练', 520.00, 1, 0),

-- 功能性训练 - 平衡训练
('单腿站立', 'Single Leg Stand', 29, 'beginner', '平衡、脚踝', '自重', '基础平衡训练', 150.00, 1, 1),
('燕式平衡', 'Bird-Dog', 29, 'beginner', '核心、平衡', '瑜伽垫', '提高核心稳定性和平衡', 180.00, 1, 1),
('单腿深蹲', 'Single Leg Squat', 29, 'advanced', '腿部、平衡', '自重', '高级平衡和力量训练', 350.00, 1, 1),
('平衡板站立', 'Balance Board Stand', 29, 'intermediate', '平衡、核心', '平衡板', '使用器械的平衡训练', 200.00, 1, 0),
('闭眼单腿站', 'Single Leg Stand with Eyes Closed', 29, 'advanced', '平衡、本体感觉', '自重', '挑战平衡感的训练', 160.00, 1, 1),

-- 功能性训练 - 敏捷训练
('梯子训练', 'Agility Ladder', 30, 'beginner', '敏捷、脚步', '敏捷梯', '提高脚步频率和敏捷性', 400.00, 1, 0),
('交叉步', 'Carioca', 30, 'beginner', '敏捷、协调性', '自重', '侧向移动的敏捷训练', 380.00, 1, 1),
('变向跑', 'Shuttle Run', 30, 'intermediate', '敏捷、速度', '锥形标志', '快速变向的敏捷训练', 450.00, 1, 0),
('绳梯步法', 'Footwork Drill', 30, 'beginner', '敏捷、脚步', '绳梯', '多种脚步组合训练', 420.00, 1, 0),
('跳栏', 'Hurdle Hop', 30, 'intermediate', '敏捷、腿部', '小栏架', '提高腿部协调性和敏捷性', 480.00, 1, 0),

-- 休闲运动顶级分类示例动作
('公园漫步', 'Park Stroll', 5, 'beginner', '全身', '舒适的鞋', '在公园轻松漫步，享受自然', 120.00, 1, 1),
('家庭园艺', 'Home Gardening', 5, 'beginner', '全身', '园艺工具', '家庭园艺活动，轻松锻炼', 180.00, 0, 0),
('太极', 'Tai Chi', 5, 'beginner', '全身、平衡', '宽松的衣服', '中国传统武术，修身养性', 200.00, 1, 1),
('广场舞', 'Square Dance', 5, 'beginner', '全身、心肺', '舒适的鞋', '集体舞蹈活动，锻炼身体和社交', 220.00, 1, 1),
('钓鱼', 'Fishing', 11, 'beginner', '手臂、核心', '鱼竿、钓具', '钓鱼是一种放松身心的户外休闲活动', 80.00, 1, 0),

-- 力量训练顶级分类示例动作
('全身力量循环', 'Full Body Strength Circuit', 6, 'intermediate', '全身肌群', '哑铃、杠铃', '综合力量训练，锻炼全身主要肌群', 450.00, 1, 0),
('硬拉', 'Deadlift', 6, 'intermediate', '下背、臀部、腿部', '杠铃', '经典力量动作，提高整体力量', 550.00, 1, 0),
('保加利亚分腿蹲', 'Bulgarian Split Squat', 6, 'intermediate', '腿部、臀部', '哑铃、长凳', '单腿力量训练，提高平衡和力量', 420.00, 1, 0),
('俯身划船', 'Bent Over Row', 6, 'intermediate', '背部、手臂', '哑铃或杠铃', '增加背部厚度和力量', 400.00, 1, 0),
('肩上推举', 'Overhead Press', 6, 'intermediate', '肩部、手臂', '哑铃或杠铃', '增强肩部和上肢力量', 380.00, 1, 0),

-- 有氧运动顶级分类示例动作
('HIIT训练', 'HIIT Training', 7, 'intermediate', '心肺、全身', '自重或器械', '高强度间歇训练，高效燃脂', 600.00, 1, 0),
('椭圆机', 'Elliptical Trainer', 7, 'beginner', '心肺、腿部', '椭圆机', '低冲击的有氧训练', 400.00, 1, 0),
('登山跑', 'Mountain Climbers', 7, 'intermediate', '心肺、核心', '自重或瑜伽垫', '高强度心肺和核心训练', 550.00, 1, 0),
('划船机', 'Rowing Machine', 7, 'intermediate', '心肺、全身', '划船机', '全身有氧和力量结合训练', 500.00, 1, 0),
('爬楼梯', 'Stair Climbing', 7, 'beginner', '心肺、腿部', '楼梯或爬楼机', '简单有效的有氧训练', 450.00, 1, 0),

-- 柔韧性训练顶级分类示例动作
('全身动态拉伸', 'Full Body Dynamic Stretch', 8, 'beginner', '全身肌肉', '自重', '运动前的动态拉伸准备', 180.00, 1, 0),
('泡沫轴放松', 'Foam Rolling', 8, 'beginner', '肌肉筋膜', '泡沫轴', '使用泡沫轴放松肌肉筋膜', 150.00, 1, 0),
('PNF拉伸', 'PNF Stretching', 8, 'intermediate', '目标肌肉', '搭档或毛巾', '本体感受神经肌肉促进拉伸', 200.00, 1, 0),
('静态拉伸组合', 'Static Stretch Combo', 8, 'beginner', '全身肌肉', '自重或瑜伽垫', '运动后的静态拉伸放松', 160.00, 1, 0),
('活动性训练', 'Mobility Training', 8, 'beginner', '关节活动度', '自重', '提高各关节活动范围', 170.00, 1, 0),

-- 功能性训练顶级分类示例动作
('农民行走', 'Farmer''s Walk', 9, 'beginner', '核心、握力、腿部', '哑铃或壶铃', '经典功能性训练，增强核心和握力', 350.00, 1, 0),
('土耳其起立', 'Turkish Get-up', 9, 'advanced', '全身、核心、平衡', '壶铃或哑铃', '复杂功能性动作，提高全身协调', 400.00, 1, 0),
('沙袋训练', 'Sandbag Training', 9, 'intermediate', '全身、核心', '沙袋', '不稳定负重的功能性训练', 420.00, 1, 0),
('战绳', 'Battle Ropes', 9, 'intermediate', '上肢、核心、心肺', '战绳', '高强度功能性和心肺训练', 480.00, 1, 0),
('雪橇推动', 'Sled Push', 9, 'intermediate', '腿部、臀部、核心', '雪橇', '下肢驱动的功能性力量训练', 500.00, 1, 0);
