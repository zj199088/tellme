        ...
        <div class="features-row">
          ...
          <div class="quick-actions animate-in glow-card" style="animation-delay: 0.3s;">
            ...
            <div class="action-buttons">
              <button class="quick-btn primary glow-button" @click="navigateToTemplates">
                <span class="btn-icon">➕</span>
                <span class="btn-text">创建计划</span>
                <span class="btn-glow"></span>
              </button>
              <button class="quick-btn secondary glow-button" @click="navigateToCreate">
                <span class="btn-icon">✏️</span>
...
const loadUserData = async () => {
  ...
  try {
    ...
    if (userInfoResponse.code === 200 && userInfoResponse.data && userStatsResponse.code === 200 && userStatsResponse.data) {
      userInfo.value = {
