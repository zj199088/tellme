  ...
  <div class="template-list-container">
    ...
    <div class="content">
      ...
      <div v-else>
        ...
        <div v-for="(template, index) in templates" :key="template.id" class="template-card glow-card animate-in" :style="{ animationDelay: `${index * 0.1}s` }" @click="">
        ...
        <div v-if="isLoggedIn" v-for="(plan, index) in sharedPlans" :key="plan.id" class="template-card glow-card animate-in" :style="{ animationDelay: `${(templates.length + index) * 0.1}s` }" @click="useSharedPlan()">
          <div class="card-inner">
            <div class="template-image">
...
import type { Category, ExerciseItem } from '../../utils/api';
