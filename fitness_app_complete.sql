...
CREATE TABLE db_migrations (
  ...
  migration_name VARCHAR(200) NOT NULL UNIQUE COMMENT '迁移文件名',
...
-- 7. 优化表
OPTIMIZE TABLE users, movement_categories, movement_exercises, templates, template_days, 
template_exercises, fitness_plans, workout_schedules, workout_schedule_exercises, 
workout_records, ai_conversations, music_tracks, user_devices, app_configs;

-- 8. 分析表统计信息
ANALYZE TABLE users, movement_categories, movement_exercises, templates, template_days, 
template_exercises, fitness_plans, workout_schedules, workout_schedule_exercises, 
workout_records, ai_conversations, music_tracks, user_devices, app_configs;
